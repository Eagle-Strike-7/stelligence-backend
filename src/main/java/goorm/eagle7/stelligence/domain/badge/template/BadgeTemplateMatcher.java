...
public class BadgeTemplateMatcher {
	...
	private final Map<BadgeCategory, BadgeAwardTemplate> strategyMap = new EnumMap<>(BadgeCategory.class);
	...
	public BadgeAwardTemplate findStrategy(BadgeCategory badgeCategory) {
