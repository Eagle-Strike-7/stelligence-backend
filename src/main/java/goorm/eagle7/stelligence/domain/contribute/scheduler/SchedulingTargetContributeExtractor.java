...
public class SchedulingTargetContributeExtractor {
	 ...
	 *
	 * <p>이러한 문제를 해결하기 위한 방법은 여러가지가 있다.<br>
	 * <ol>
	 *     <li>시간 범위를 오버랩시킨다: 시간 범위를 중복되게 만들어 간극을 커버하기</li>
	 *     <li>상태 기록: 별도의 공간에 발생한 쿼리의 시간 정보를 저장하여 간극 없애기</li>
	 * </ol>
	 * 1번을 채택하기로 하고,
